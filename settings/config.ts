...
CultureBot.fuzzy(
  ...
  ($bot, msg) => {
    const rosterImages = [
      // "https://github.com/valgaze/project-northstar/raw/deploy/assets/dalle1.png", // fails to render?
      "https://github.com/valgaze/project-northstar/raw/deploy/assets/dalle2.png",
      "https://github.com/valgaze/project-northstar/raw/deploy/assets/dalle3.png",
      "https://github.com/valgaze/project-northstar/raw/deploy/assets/dalle4.png",
      "https://github.com/valgaze/project-northstar/raw/deploy/assets/dalle5.png",
      "https://github.com/valgaze/project-northstar/raw/deploy/assets/dalle6.png",
      "https://github.com/valgaze/project-northstar/raw/deploy/assets/dalle7.png",
      "https://github.com/valgaze/project-northstar/raw/deploy/assets/dalle8.png",
      "https://github.com/valgaze/project-northstar/raw/deploy/assets/dalle9.png",
      "https://github.com/valgaze/project-northstar/raw/deploy/assets/dalle10.png",
    ];
    ...
    const card = $bot
      .card({
        ...
        subTitle:
          "Project Northstar: testbed of unique integrations available to conversation design systems. More will be added-- get started by clicking or saying 'Location'",
        chips: [
          { keyword: "Location", label: "🌍 Location Integration" },
          { keyword: "alerts", label: "📱 Demo alert types" },
          { keyword: "sendfiles", label: "🗂 Demo File Capabilities" },
          { keyword: "ping", label: "ping 🏓" },
          { keyword: "pong", label: "🏓 pong" },
          { keyword: "hi", label: "🔁 Restart" },
        ],
        image: luckyImage,
      })
      .setDetail(
        $bot
          ...
          .setText(
            "👹 **[Bug Report](https://github.com/valgaze/project-northstar/issues/new?assignees=octocat&labels=bug%2Ctriage&template=kitchensink.yml&title=%5BBug%5D%3A+)**"
          )
          .setText(
            "💡 **[Feature Idea](https://github.com/valgaze/project-northstar/issues/new?assignees=&labels=enhancement&template=feature_request.yml)**"
          )
          .setText(
            "📚 Read **[The API Docs](https://github.com/valgaze/speedybot-mini/blob/deploy/api-docs/classes/BotInst.md#methods)**"
          )
          .setText(
            "💬 **[Discuss + Get Help](https://github.com/valgaze/project-northstar/discussions)**"
          )
          .setText(
...
CultureBot.fuzzy("location", async ($bot, msg) => {
  // HACK
  $bot.meta.url = "https://northstar.valgaze.workers.dev/";
  ...
  const sentMsg = await $bot.send(rootMessage);
  // Hack: later pass in url through typed secrets/value mechanism
  const url = `${$bot.meta.url}location?roomId=${msg.data.roomId}&messageId=${sentMsg.id}`;
...
CultureBot.fuzzy(["help", "how do i"], ($bot, msg) => {
  const card = $bot
    .card({
      ...
      chips: [
        { keyword: "Location", label: "📍 Location Demo" },
        { keyword: "Integration2", label: "Integration 2" },
        { keyword: "ping", label: "ping 🏓" },
        { keyword: "pong", label: "🏓 pong" },
